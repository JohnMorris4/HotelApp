    ...
    public class SqlData : IDatabaseData
    {
            ...
            )
        {
            ...
            RoomTypeModel roomType = _db.LoadData<RoomTypeModel, dynamic>(
                    "select * from dbo.RoomTypes were Id = @Id",
                    new { Id = roomTypeId },
                    connectionStringName,
                    false
            ).First();
        ...
        public List<BookingFullModel> SearchBookings(string lastName)
        {
            return _db.LoadData<BookingFullModel, dynamic>("dbo.spBookings_Search",
                new { lastName, startDate = DateTime.Now.Date }, connectionStringName, true);
        }

        public void CheckInGuest(int bookingId)
        {
            _db.SaveData("dbo.spBookings_CheckedIn",
                new { Id = bookingId }, connectionStringName, true);
        }
    }
}
